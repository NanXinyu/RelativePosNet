...
_C.MODEL.PATCH_SIZE = [8, 8] #[16, 16]
_C.MODEL.HEATMAP_SIZE = [64, 64]
_C.MODEL.NUM_PATCHES = 64
_C.MODEL.HIDDEN_CHANNELS = [64, 128, 256]
...
_C.DATASET.SELECT_DATA = False # DO NOT SELECT DATA
...
_C.TEST.USE_GT_BBOX = True # TEST USE GT BBOX IN ANN
...
def update_config(cfg):
    ...
    cfg.DATASET_ROOT = osp.join(
        cfg.DATA_DIR, cfg.DATASET.DATASET, cfg.DATASET.ROOT
    )
